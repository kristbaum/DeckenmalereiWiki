...
class MediaWikiImporter:
    ...
    def __init__(self, host: str = "localhost", port: int = 8080, 
                 ...
                 scheme: str = "http", enable_images: bool = False,
                 max_articles: int = 10):
    ...
    def upload_image(self, filepath: Path, description: str = "", 
                    license_info: str = "") -> bool:
    ...
    def create_or_update_page(self, title: str, content: str, 
                             summary: str = "Automatischer Import") -> bool:
    ...
    def import_from_parser(self, parser):
        ...
        print(f"Processing {len(text_entities)} articles (max_articles={self.max_articles})")
